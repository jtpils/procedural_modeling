...
parameter_dict['trunk_pitch_angle'] = 10.0            #pitch down wrt turtle's left, in degrees
parameter_dict['trunk_roll_angle'] = 45.0             #roll left wrt turtle's head, in degrees
...
parameter_dict['no_second_ord_branches'] = 2  #number of second order branches (assume uniformity)
